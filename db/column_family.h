...
class ColumnFamilyData {
 public:
  ...
  // void update_index_cache(MemTable* table);
 ...
 public:
  ...
  void set_index_cache(IndexCache* local_cache) {
    index_cache_ = local_cache;
  }
  ...
  inline IndexCache* index_cache() const { return index_cache_; }
...
class ColumnFamilySet {
 public:
  ...
  // IndexCache* get_index_cache() {return local_cache_; }

  // void set_index_cache(IndexCache* local_cache) {
  //   local_cache_ = local_cache;
  // }
  // IndexCache* local_cache_;
