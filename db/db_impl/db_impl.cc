...
DBImpl::DBImpl(const DBOptions& options, const std::string& dbname,
  ...
  // local_cache_ = new IndexCache();
  // IndexCache* local_index_cache;
  // LOG_CERR("local_index_cache : ", local_index_cache);
  // local_index_cache = new IndexCache();
  // LOG_CERR("local_index_cache: ", local_index_cache);
  // set_index_cache(local_index_cache);
  // LOG_CERR("db_impl local cache: ", index_cache());
  // if (versions_->GetColumnFamilySet() == nullptr) {
  //   LOG_CERR("empty set");
  // }
  // versions_->GetColumnFamilySet()->set_index_cache(index_cache());
  // LOG_CERR("setted pointer: ", versions_->GetColumnFamilySet()->get_index_cache());
