...
// Current the following isn't equivalent to OS_LINUX.
 ...
 private:
  ...
  void InitializeOptionsFromFlags(Options* opts) {
    ...
    options.local_index_cache = new IndexCache(838860, 0);
    LOG_CERR("init cache: ", options.local_index_cache);
    options.max_local_write_buffer_number = FLAGS_max_local_write_buffer_number;
  ...
  void Open(Options* opts) {
    ...
    auto index_cache = new IndexCache(838860, 0);
    db_.db->set_local_index_cache(index_cache);
